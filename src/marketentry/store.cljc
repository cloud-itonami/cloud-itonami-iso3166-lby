(ns marketentry.store
  "SSoT for the Libya (LBY) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:office-balance-lyd` is ground truth for the flagship MAINTAINED
  BANK-BALANCE FLOOR VALIDATION check (Ministry of Economy and Trade's
  own foreign-company-representative-office registration-requirements
  page -- LYD 150,000 floor)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Tripoli Trading & Services Office" :registration-channel "Ministry of Economy and Trade -- Commercial Registry (Tripoli)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :office-balance-lyd 150000
             :drafted? false :submitted? false
             :jurisdiction "LBY" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :registration-channel "Ministry of Economy and Trade -- Commercial Registry (Tripoli)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :office-balance-lyd 150000
             :drafted? false :submitted? false
             :jurisdiction "ATL" :status :intake}
    "eng-3" {:id "eng-3" :operator "Benghazi Import-Export Office" :registration-channel "Ministry of Economy and Trade -- Commercial Registry (Benghazi)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 999000.0
             :office-balance-lyd 150000
             :drafted? false :submitted? false
             :jurisdiction "LBY" :status :intake}
    "eng-4" {:id "eng-4" :operator "Misrata Logistics Representative Office" :registration-channel "Ministry of Economy and Trade -- Commercial Registry (Tripoli)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :office-balance-lyd 90000
             :drafted? false :submitted? false
             :jurisdiction "LBY" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator registration-channel base-fee monthly-rate monitoring-months claimed-fee
                               office-balance-lyd
                               drafted? submitted?
                               jurisdiction status draft-number submit-number]}]
  (cond-> {:engagement/id id}
    operator                                       (assoc :engagement/operator operator)
    registration-channel                            (assoc :engagement/registration-channel registration-channel)
    ...
    office-balance-lyd                             (assoc :engagement/office-balance-lyd office-balance-lyd)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/registration-channel :engagement/base-fee :engagement/monthly-rate
   :engagement/monitoring-months :engagement/claimed-fee
   :engagement/office-balance-lyd
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :registration-channel (:engagement/registration-channel m)
     ...
     :office-balance-lyd (:engagement/office-balance-lyd m)
