(ns marketentry.phase
  "Phase 0->3 staged rollout for the Libya (LBY) market-entry compliance
  actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no filing risk
                                 yet) may auto-commit.
  ...
  real Ministry of Economy and Trade / Commercial Registry
  business-registration filing package and submitting a real filing are
  the two real-world acts this actor performs; both are always a human
  market-entry operator's call. `marketentry.governor`'s
